...
mod tests {
    ...
    fn test_tokenize() {
        ...
        let mut tokens = vec![];
        tokenize(primitives, &mut tokens);
        ...
        equal_token_tuple(
            ...
            &TokenType::Bool(Range::new(
                Position::new(0, 44, 44),
                Position::new(0, 49, 49),
            ), false),
        );
        ...
        equal_token_tuple(
            ...
            &TokenType::Int(Range::new(
                Position::new(0, 73, 73),
                Position::new(0, 74, 74),
            ), 1),
        );
        ...
        equal_token_tuple(
            ...
            &TokenType::Float(Range::new(
                Position::new(0, 85, 85),
                Position::new(0, 88, 88),
            ), 1.0),
        );
        ...
        equal_token_single(
            ...
            &TokenType::ArrayOpen(
                Range::new(Position::new(0, 99, 99), Position::new(0, 100, 100)),
            ),
        );
        ...
        equal_token_single(
            ...
            &TokenType::ArrayClose(
                Range::new(Position::new(0, 100, 100), Position::new(0, 101, 101)),
            ),
        );
        ...
        equal_token_single(
            ...
            &TokenType::ObjectClose(
                Range::new(Position::new(0, 102, 102), Position::new(0, 103, 103)),
            ),
        );
    }
